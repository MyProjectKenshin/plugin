...
1. Admin interface - enter username, channel ID, and choose tabs.
2. Player, thumb, grid style options.
3. YourChannel - top part, banner with videos.
3. YourChannel - bottom part, load more button.
3. Playlists in responsive view.
...
= 0.7.4 =
* Made inline player appear in center of screen.
