...
/**
 * kenshin
 * WP_REST_Video_Controller class.
 */
if (!class_exists('WP_REST_Video_Controller')) {
    require_once dirname(__FILE__) . '/lib/endpoints/class-wp-rest-video-controller.php';
}

/**
 * kenshin add
 * WP_REST_RSS_Controller class.
 */
if (!class_exists('WP_REST_Rss_Controller')) {
    require_once dirname(__FILE__) . '/lib/endpoints/class-wp-rest-rss-controller.php';
}
...
if (!function_exists('create_initial_rest_routes')) {
    ...
    function create_initial_rest_routes()
    {
        ...
        // Video kenshin add.
        $controller = new WP_REST_Video_Controller();
        $controller->register_routes();

        // Video kenshin add.
        $controller = new WP_REST_RSS_Controller();
        $controller->register_routes();
