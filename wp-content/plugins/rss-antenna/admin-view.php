<div class="wrap">
	...
	<div class="updated" style="border: 2px solid #1E8CBE !important;border-radius: 3px;">
		<p class='updated'>複数のRSS一覧を表示できる<strong><a
					href="http://residentbird.main.jp/bizplugin/plugins/rss-antenna-site/" target="_blank">RSS Antenna
					Siteはこちら</a></strong>です</p>
	</div>
	<h3>ショートコード</h3>
